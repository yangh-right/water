!(function (e) {
  ...
  function (e, n, t) {
    ...
    function l(e, n) {
      if (null != e)
        ...
        else for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && n.call(null, e[o], o, e);
    }
    e.exports = {
      isArray: s,
  ...
  function (e, n, t) {
    var r = t(1),
      ...
      A = function (e, n, t) {
        ...
        for (l in (p && (t = n), t))
          (u = ((c = !f && g && void 0 !== g[l]) ? g : t)[l]),
            (v = j && c ? a(u, r) : h && "function" == typeof u ? a(Function.call, u) : u),
            g && s(g, l, u, e & A.U),
            b[l] != u && i(b, l, v),
            h && m[l] != u && (m[l] = u);
      };
  ...
  function (e, n, t) {
    ...
    (t(13).inspectSource = function (e) {
      ...
      (e.exports = function (e, n, t, a) {
        ...
        l && (i(t, "name") || o(t, "name", n)),
          e[n] !== t &&
            (l && (i(t, s) || o(t, s, e[n] ? "" + e[n] : A.join(String(n)))),
            e === r ? (e[n] = t) : a ? (e[n] ? (e[n] = t) : o(e, n, t)) : (delete e[n], o(e, n, t)));
       ...
       */ (function () {
        ...
        function m(e, n) {
          ...
          return (
            (function (e, n) {
              var t = -1,
                r = e ? e.length : 0;
              if ("number" == typeof r && r > -1 && r <= c) for (; ++t < r; ) n(e[t], t, e);
              else j(e, n);
            })(e, function (r, o) {
              t = n(t, r, o, e);
            }),
        ...
        var y = (function e(n) {
          ...
          var a,
            ...
            c,
            v,
            f = r ? !!o.likeChrome : /\bChrome\b/.test(n) && !/internal|\n/i.test(p.toString()),
            ...
            R = (function (e) {
              return m(e, function (e, t, r) {
                return (
                  e ||
                  ((t[Q] ||
                    t[/^[a-z]+(?: +[a-z]+\b)*/i.exec(Q)] ||
                    RegExp("\\b" + b(r) + "(?:\\b|\\w*\\d)", "i").exec(n)) &&
                    r)
                );
              });
            })({
          ...
          if (
            (L && (L = [L]),
            R && !Q && (Q = F([R])),
            (a = /\bGoogle TV\b/.exec(Q)) && (Q = a[0]),
            /\bSimulator\b/i.test(n) && (Q = (Q ? Q + " " : "") + "Simulator"),
            "Opera Mini" == G && /\bOPiOS\b/.test(n) && k.push("running in Turbo/Uncompressed mode"),
            "IE" == G && /\blike iPhone OS\b/.test(n)
              ? ((R = (a = e(n.replace(/like iPhone OS/, ""))).manufacturer), (Q = a.product))
              : /^iP/.test(Q)
              ? (G || (G = "Safari"),
                (Z = "iOS" + ((a = / OS ([\d_]+)/i.exec(n)) ? " " + a[1].replace(/_/g, ".") : "")))
              : "Konqueror" != G || /buntu/i.test(Z)
              ? (R && "Google" != R && ((/Chrome/.test(G) && !/\bMobile Safari\b/i.test(n)) || /\bVita\b/.test(Q))) ||
                (/\bAndroid\b/.test(Z) && /^Chrome/.test(G) && /\bVersion\//i.test(n))
                ? ((G = "Android Browser"), (Z = /\bAndroid\b/.test(Z) ? Z : "Android"))
                : "Silk" == G
                ? (/\bMobi/i.test(n) || ((Z = "Android"), k.unshift("desktop mode")),
                  /Accelerated *= *true/i.test(n) && k.unshift("accelerated"))
                : "PaleMoon" == G && (a = /\bFirefox\/([\d.]+)\b/.exec(n))
                ? k.push("identifying as Firefox " + a[1])
                : "Firefox" == G && (a = /\b(Mobile|Tablet|TV)\b/i.exec(n))
                ? (Z || (Z = "Firefox OS"), Q || (Q = a[1]))
                : !G || (a = !/\bMinefield\b/i.test(n) && /\b(?:Firefox|Safari)\b/.exec(G))
                ? (G && !Q && /[\/,]|^[^(]+?\)/.test(n.slice(n.indexOf(a + "/") + 8)) && (G = null),
                  (a = Q || R || Z) &&
                    (Q || R || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(Z)) &&
                    (G = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(Z) ? Z : a) + " Browser"))
                : "Electron" == G && (a = (/\bChrome\/([\d.]+)\b/.exec(n) || 0)[1]) && k.push("Chromium " + a)
              : (Z = "Kubuntu"),
            D ||
              (D = m(
                [
                ...
                function (e, t) {
                  return (
                    e ||
                    (RegExp(t + "(?:-[\\d.]+/|(?: for [\\w-]+)?[ /-])([\\d.]+[^ ();/_-]*)", "i").exec(n) || 0)[1] ||
                    null
                  );
                }
              )),
            (a =
              ("iCab" == L && parseFloat(D) > 3
                ? "WebKit"
                : /\bOpera\b/.test(G) && (/\bOPR\b/.test(n) ? "Blink" : "Presto")) ||
              (/\b(?:Midori|Nook|Safari)\b/i.test(n) && !/^(?:Trident|EdgeHTML)$/.test(L) && "WebKit") ||
              (!L && /\bMSIE\b/i.test(n) && ("Mac OS" == Z ? "Tasman" : "Trident")) ||
              ("WebKit" == L && /\bPlayStation\b(?! Vita\b)/i.test(G) && "NetFront")) && (L = [a]),
            "IE" == G && (a = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(n) || 0)[1])
              ? ((G += " Mobile"), (Z = "Windows Phone " + (/\+$/.test(a) ? a : a + ".x")), k.unshift("desktop mode"))
              ...
              : "IE" != G &&
                "Trident" == L &&
                (a = /\brv:([\d.]+)/.exec(n)) &&
                (G && k.push("identifying as " + G + (D ? " " + D : "")), (G = "IE"), (D = a[1])),
            C)
          ) {
            if (
              ((c = "global"),
              (v = null != (l = t) ? typeof l[c] : "number"),
              /^(?:boolean|number|string|undefined)$/.test(v) || ("object" == v && !l[c]))
            )
              g((a = t.runtime)) == d
                ? ((G = "Adobe AIR"), (Z = a.flash.system.Capabilities.os))
                : g((a = t.phantom)) == w
                ? ((G = "PhantomJS"), (D = (a = a.version || null) && a.major + "." + a.minor + "." + a.patch))
                : "number" == typeof T.documentMode && (a = /\bTrident\/(\d+)/i.exec(n))
                ? ((D = [D, T.documentMode]),
                  (a = +a[1] + 4) != D[1] && (k.push("IE " + D[1] + " mode"), L && (L[1] = ""), (D[1] = a)),
                  (D = "IE" == G ? String(D[1].toFixed(1)) : D[0]))
                : "number" == typeof T.documentMode &&
                  /^(?:Chrome|Firefox)\b/.test(G) &&
                  (k.push("masking as " + G + " " + D), (G = "IE"), (D = "11.0"), (L = ["Trident"]), (Z = "Windows"));
            else if (
              (I &&
                ((B = (a = I.lang.System).getProperty("os.arch")),
                ...
                ("object" == typeof a.versions &&
                  ("string" == typeof a.versions.electron
                    ...
                    : "string" == typeof a.versions.nw &&
                      (k.push("Chromium " + D, "Node " + a.versions.node), (G = "NW.js"), (D = a.versions.nw))),
                G ||
                  ((G = "Node.js"),
                  (B = a.arch),
                  (Z = a.platform),
                  (D = (D = /[\d.]+/.exec(a.version)) ? D[0] : null)));
            Z = Z && h(Z);
          }
          if (
            (D &&
              ...
              (D = D.replace(RegExp(a + "\\+?$"), "") + ("beta" == O ? N : E) + (/\d+\+?/.exec(a) || ""))),
            "Fennec" == G || ("Firefox" == G && /\b(?:Android|Firefox OS)\b/.test(Z)))
          )
            G = "Firefox Mobile";
          else if ("Maxthon" == G && D) D = D.replace(/\.[\d.]+/, ".x");
          else if (/\bXbox\b/i.test(Q))
            "Xbox 360" == Q && (Z = null), "Xbox 360" == Q && /\bIEMobile\b/.test(n) && k.unshift("mobile mode");
          else if (
            (!/^(?:Chrome|IE|Opera)$/.test(G) && (!G || Q || /Browser|Mobi/.test(G))) ||
            ...
            if ("IE" == G && C)
              ...
              (/\bBlackBerry\b/.test(Q) || /\bBB10\b/.test(n)) &&
              (a = (RegExp(Q.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(n) || 0)[1] || D)
                ? ((Z =
                    ((a = [a, /BB10/.test(n)])[1] ? ((Q = null), (R = "BlackBerry")) : "Device Software") + " " + a[0]),
                  (D = null))
                : this != j &&
                  "Wii" != Q &&
                  ((C && Y) ||
                    (/Opera/.test(G) && /\b(?:MSIE|Firefox)\b/i.test(n)) ||
                    ("Firefox" == G && /\bOS X (?:\d+\.){2,}/.test(Z)) ||
                    ("IE" == G &&
                      ((Z && !/^Win/.test(Z) && D > 5.5) ||
                        (/\bWindows XP\b/.test(Z) && D > 8) ||
                        (8 == D && !/\bTrident\b/.test(n))))) &&
                  !u.test((a = e.call(j, n.replace(u, "") + ";"))) &&
                  a.name &&
                  ((a = "ing as " + a.name + ((a = a.version) ? " " + a : "")),
                  u.test(G)
                    ? (/\bIE\b/.test(a) && "Mac OS" == Z && (Z = null), (a = "identify" + a))
                    : ((a = "mask" + a),
                      (G = S ? h(S.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera"),
                      /\bIE\b/.test(a) && (Z = null),
                      C || (D = null)),
                  (L = ["Presto"]),
                  k.push(a));
          else G += " Mobile";
          (a = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(n) || 0)[1]) &&
            ((a = [parseFloat(a.replace(/\.(\d)$/, ".0$1")), a]),
            "Safari" == G && "+" == a[1].slice(-1)
              ? ((G = "WebKit Nightly"), (O = "alpha"), (D = a[1].slice(0, -1)))
              : (D != a[1] && D != (a[2] = (/\bSafari\/([\d.]+\+?)/i.exec(n) || 0)[1])) || (D = null),
            (a[1] = (/\bChrome\/([\d.]+)/i.exec(n) || 0)[1]),
            537.36 == a[0] && 537.36 == a[2] && parseFloat(a[1]) >= 28 && "WebKit" == L && (L = ["Blink"]),
            C && (f || a[1])
              ? (L && (L[1] = "like Chrome"),
                (a =
                  a[1] ||
              ...
              : (L && (L[1] = "like Safari"),
                (a =
                  (a = a[0]) < 400
                    ...
                    ? 8
                    : "8")),
            L && (L[1] += " " + (a += "number" == typeof a ? ".x" : /[.+]/.test(a) ? "" : "+")),
            "Safari" == G && (!D || parseInt(D) > 45) && (D = a)),
            "Opera" == G && (a = /\bzbov|zvav$/.exec(Z))
              ? ((G += " "),
                k.unshift("desktop mode"),
                "zvav" == a ? ((G += "Mini"), (D = null)) : (G += "Mobile"),
              ...
              : "Safari" == G &&
                ...
                (G = "Chrome Mobile"),
                (D = null),
                /\bOS X\b/.test(Z) ? ((R = "Apple"), (Z = "iOS 4.3+")) : (Z = null)),
            D && 0 == D.indexOf((a = /[\d.]+$/.exec(Z))) && n.indexOf("/" + a + "-") > -1 && (Z = M(Z.replace(a, ""))),
            L &&
              !/\b(?:Avant|Nook)\b/.test(G) &&
              (/Browser|Lunascape|Maxthon/.test(G) ||
                ("Safari" != G && /^iOS/.test(Z) && /\bSafari\b/.test(L[1])) ||
                (/^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|Web)/.test(G) &&
                  L[1])) &&
              (a = L[L.length - 1]) &&
              k.push(a),
            k.length && (k = ["(" + k.join("; ") + ")"]),
            R && Q && Q.indexOf(R) < 0 && k.push("on " + R),
            Q && k.push((/^on /.test(k[k.length - 1]) ? "" : "on ") + Q),
            Z &&
              ((a = / ([\d.+]+)$/.exec(Z)),
              (A = a && "/" == Z.charAt(Z.length - a[0].length - 1)),
              (Z = {
                architecture: 32,
            ...
            (a = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(B)) && !/\bi686\b/i.test(B)
              ? (Z && ((Z.architecture = 64), (Z.family = Z.family.replace(RegExp(" *" + a), ""))),
                G &&
                  (/\bWOW64\b/i.test(n) ||
                    (C && /\w(?:86|32)$/.test(o.cpuClass || o.platform) && !/\bWin64; x64\b/i.test(n))) &&
                  k.unshift("32-bit"))
              : Z && /^OS X/.test(Z.family) && "Chrome" == G && parseFloat(D) >= 39 && (Z.architecture = 64),
            n || (n = null);
          var P = {};
          return (
            (P.description = n),
            ...
            P.version && k.unshift(D),
            P.name && k.unshift(G),
            Z &&
              G &&
              (Z != String(Z).split(" ")[0] || (Z != G.split(" ")[0] && !Q)) &&
              k.push(Q ? "(" + Z + ")" : "on " + Z),
            k.length && (P.description = k.join(" ")),
            P
          );
        })();
        (s.platform = y),
  ...
  function (e, n, t) {
    var r = t(6).f,
      ...
      i = t(0)("toStringTag");
    e.exports = function (e, n, t) {
      e && !o((e = t ? e : e.prototype), i) && r(e, i, { configurable: !0, value: n });
    };
  },
  function (e, n, t) {
    "use strict";
      ...
      return (
            ...
            var t = (function (e, n) {
              ...
              if (n && "function" == typeof btoa) {
                var o =
                    ...
                    (A = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a)),
                    "/*# ".concat(A, " */")),
        ...
        (n.i = function (e, t) {
          ...
          for (var s = 0; s < e.length; s++) {
            var a = e[s];
            (null != a[0] && r[a[0]]) ||
              (t && !a[2] ? (a[2] = t) : t && (a[2] = "(".concat(a[2], ") and (").concat(t, ")")), n.push(a));
          }
        }),
        n
      );
    ...
    (l || c) &&
      (A = function (e) {
        var n,
          ...
          A = this;
        return (
          c && (t = new RegExp("^" + A.source + "$(?!\\s)", i.call(A))),
          l && (n = A.lastIndex),
          (r = s.call(A, e)),
  ...
  function (e, n, t) {
    var r = (function (e) {
      ...
      return (
        (h.prototype = M.constructor = j),
        (j.constructor = h),
        (j[a] = h.displayName = "GeneratorFunction"),
        ...
        (e.mark = function (e) {
          return (
            Object.setPrototypeOf
              ...
              : ((e.__proto__ = j), a in e || (e[a] = "GeneratorFunction")),
        ...
        (E.prototype = {
          ...
          abrupt: function (e, n) {
            ...
            return (
              (s.type = e), (s.arg = n), i ? ((this.method = "next"), (this.next = i.finallyLoc), p) : this.complete(s)
            );
          },
  ...
  function (e, n, t) {
    ...
    e.exports =
      ...
      function (e, n) {
        var t;
        return (
          null !== e ? ((a.prototype = r(e)), (t = new a()), (a.prototype = null), (t[s] = e)) : (t = A()),
          void 0 === n ? t : o(t, n)
        );
      };
  },
  function (e, n, t) {
    ...
    (e.exports = t(105)(
      ...
      function () {
        ...
        return !e || t >= e.length
          ? ((this._t = void 0), o(1))
          : o(0, "keys" == n ? t : "values" == n ? e[t] : [t, e[t]]);
      },
      "values"
    )),
      (i.Arguments = i.Array),
  ...
  function (e, n, t) {
    e.exports =
      ...
      !t(7)(function () {
        return (
          7 !=
          Object.defineProperty(t(42)("div"), "a", {
            get: function () {
              return 7;
            },
          }).a
  ...
  function (e, n, t) {
    ...
    e.exports = function (e) {
      return function (n, t, s) {
        ...
        } else for (; l > c; c++) if ((e || c in A) && A[c] === t) return e || c || 0;
        return !e && -1;
      };
    };
  },
          ...
          "".split(/.?/).length
            ? function (e, n) {
                ...
                for (
                  ...
                  !(
                    (s = p.lastIndex) > u &&
                    (A.push(o.slice(u, i.index)),
                    i.length > 1 && i.index < o.length && v.apply(A, i.slice(1)),
                    (a = i[0].length),
                    (u = s),
                    A.length >= f)
                  );
                ...
                return (
                  u === o.length ? (!a && p.test("")) || A.push("") : A.push(o.slice(u)),
        ...
        function (e, n) {
          ...
          for (var m, M = "", y = 0, z = 0; z < g.length; z++) {
            ...
            for (var w = String(b[0]), I = l(c(s(b.index), v.length), 0), x = [], E = 1; E < b.length; E++)
              x.push(void 0 === (m = b[E]) ? m : String(m));
            var N = b.groups;
            if (f) {
  ...
  function (e, n, t) {
    ...
    (v && f) ||
      ...
      "process" == t(15)(u)
        ...
        : p
        ? ((i = (o = new p()).port2), (o.port1.onmessage = b), (r = s(i.postMessage, i, 1)))
        ...
        A = {
          adapter:
            (void 0 !== n && "[object process]" === Object.prototype.toString.call(n)
              ? (a = t(75))
              : "undefined" != typeof XMLHttpRequest && (a = t(75)),
            a),
          transformRequest: [
            function (e, n) {
              return (
                ...
                r.isFormData(e) || r.isArrayBuffer(e) || r.isBuffer(e) || r.isStream(e) || r.isFile(e) || r.isBlob(e)
                  ...
                  ? (s(n, "application/x-www-form-urlencoded;charset=utf-8"), e.toString())
                  : r.isObject(e)
                  ? (s(n, "application/json;charset=utf-8"), JSON.stringify(e))
                  : e
              );
            },
          ],
  ...
  function (e, n, t) {
    ...
    e.exports = function (e) {
      return new Promise(function (n, l) {
        ...
        if (
          (v.open(e.method.toUpperCase(), i(e.url, e.params, e.paramsSerializer), !0),
          (v.timeout = e.timeout),
      ...
      return function (n, t) {
        ...
        return A < 0 || A >= l
          ? e
            ? ""
            : void 0
          : (i = a.charCodeAt(A)) < 55296 || i > 56319 || A + 1 === l || (s = a.charCodeAt(A + 1)) < 56320 || s > 57343
          ? e
            ? a.charAt(A)
            : i
          : e
  ...
  function (e, n, t) {
    "use strict";
    var r = t(45);
    t(8)({ target: "RegExp", proto: !0, forced: r !== /./.exec }, { exec: r });
  },
  function (e, n, t) {
    "use strict";
    var r = t(8),
  ...
  function (e, n, t) {
    t(4) && "g" != /./g.flags && t(6).f(RegExp.prototype, "flags", { configurable: !0, get: t(46) });
  },
  function (e, n, t) {
    "use strict";
    var r = t(1),
      ...
      g = function (e) {
        ...
        if ("string" == typeof n && n.length > 2) {
          var t,
            r,
            o,
            i = (n = j ? n.trim() : v(n, 3)).charCodeAt(0);
          if (43 === i || 45 === i) {
    ...
    e.exports = {
      set:
        ...
        ("__proto__" in {}
          ? (function (e, n, r) {
              try {
                (r = t(23)(Function.call, t(35).f(Object.prototype, "__proto__").set, 2))(e, []),
  ...
  function (e, n, t) {
    ...
    e.exports = function (e, n, t, p, d, h, j) {
      ...
      if (
        (T &&
          (m = c(T.call(new e()))) !== Object.prototype &&
          m.next &&
          (l(m, y, !0), r || "function" == typeof m[u] || s(m, u, f)),
        z &&
          x &&
          "values" !== x.name &&
          ((w = !0),
        ...
        if (((g = { values: z ? E : M("values"), keys: h ? E : M("keys"), entries: N }), j))
  ...
  function (e, n, t) {
    ...
    t(11)(s, t(0)("iterator"), function () {
      ...
      (e.exports = function (e, n, t) {
        (e.prototype = r(s, { next: o(1, t) })), i(e, n + " Iterator");
      });
  },
  function (e, n, t) {
    var r = t(12),
  ...
  function (e, n, t) {
    ...
    var r,
              ...
              var r = e._v,
                ...
                s = function (n) {
                  ...
                  try {
                    a
                      ? (o || (2 == e._h && D(e), (e._h = 1)),
                        !0 === a ? (t = r) : (c && c.enter(), (t = a(r)), c && (c.exit(), (s = !0))),
                        t === n.promise ? l(z("Promise-chain cycle")) : (i = B(t)) ? i.call(t, A, l) : A(t))
                      : l(r);
                  } catch (e) {
                    c && !s && c.exit(), l(e);
                  }
      ...
      D = function (e) {
        j.call(A, function () {
          var n;
          N ? w.emit("rejectionHandled", e) : (n = A.onrejectionhandled) && n({ promise: e, reason: e._v });
        });
      },
      L = function (e) {
        var n = this;
  ...
  function (e, n, t) {
    ...
    ((n = e.exports =
      function (e, n, t, u, v) {
        ...
        } else for (d = j.call(e); !(p = d.next()).done; ) if ((h = o(d, g, p.value, n)) === l || h === c) return h;
      }).BREAK = l),
      (n.RETURN = c);
  },
  function (e, n, t) {
  ...
  function (e, n, t) {
    ...
    e.exports = function () {
      ...
      if (A)
        ...
        new i(l).observe(v, { characterData: !0 }),
          (t = function () {
            v.data = u = !u;
          });
      }
  ...
  function (e, n, t) {
    ...
    var r = t(1),
      ...
      X = function (e, n, t) {
        return (
          ...
          o(R, n)
            ? (t.enumerable
                ? (o(e, D) && e[D][n] && (e[D][n] = !1), (t = w(t, { enumerable: z(0, !1) })))
                : (o(e, D) || S(e, D, z(1, {})), (e[D][n] = !0)),
              J(e, n, t))
            : S(e, n, t)
        );
      },
      ...
      K = function (e) {
        ...
        return (
          !(this === F && o(R, e) && !o(Z, e)) && (!(n || !o(this, e) || !o(R, e) || (o(this, D) && this[D][e])) || n)
        );
      },
      q = function (e, n) {
    ...
    P ||
      (a(
        (k = function () {
          ...
          return i && W && J(F, e, { configurable: !0, set: n }), H(e);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      (t(33).f = K),
      (E.f = ee),
      i && !t(22) && a(F, "propertyIsEnumerable", K, !0),
      (p.f = function (e) {
        return H(f(e));
      })),
      s(s.G + s.W + s.F * !P, { Symbol: k });
    for (
      var ne =
    ...
    s(s.S + s.F * ie, "Object", {
      ...
      k.prototype[L] || t(11)(k.prototype, L, k.prototype.valueOf),
      u(k, "Symbol"),
      u(Math, "Math", !0),
      u(r.JSON, "JSON", !0);
  },
  ...
  function (e, n, t) {
    ...
    e.exports = function (e) {
      ...
      "_" == e.charAt(0) || e in n || a(n, e, { value: s.f(e) });
    };
  },
  function (e, n, t) {
    var r = t(18),
  ...
  function (e, n, t) {
    ...
    e.exports = function (e) {
      return (
        l(e),
        e.baseURL && !a(e.url) && (e.url = A(e.baseURL, e.url)),
        (e.headers = e.headers || {}),
        ...
        (e.adapter || s.adapter)(e).then(
          ...
          function (n) {
            return (
              i(n) ||
                (l(e),
                n && n.response && (n.response.data = o(n.response.data, n.response.headers, e.transformResponse))),
              Promise.reject(n)
            );
          }
        )
  ...
  function (e, n, t) {
    ...
    var r = t(26),
      ...
      f =
        ...
        t(109),
        {
          ...
          logsFunction: function () {
            return f.isIE() ? { info: function () {}, error: function () {}, log: function () {} } : console;
          },
        }),
      p = f,
      d = (t(123), t(126), t(81)),
      ...
      y = t.n(M),
      z = [
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/public.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/md5.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/mp4remux.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/videoMediaSource.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/WebsocketServer.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/Sylvester.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/WebGLCanvas.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/audioPlayer.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/workerManager.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/streamDrawer.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/playerControl.js`,
        `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/ivs.js`,
      ],
      w = [`${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/video.min.js`,
          `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/videojs-flash.js`,
          `${window.publicPath??'/secondary_water_supply/'}js/imouPlayer/static/videojs-contrib-hls.min.js`];
    function I(e, n) {
      var t = Object.keys(e);
      if (Object.getOwnPropertySymbols) {
    ...
    var x = p.logsFunction(),
      ...
      N = (function () {
        function e(n) {
          ...
          Object.defineProperty(this.playerStatus, "isMuted", {
            ...
            set: function (e) {
              t.videoPlayer &&
                ...
                p.setAttr(
                  t.btnSound,
                  "class",
                  "player__btn player__btn-large iconfont icon".concat(e ? "jingyin" : "shengyin")
                ),
                (r = e);
            },
          }),
            ...
            p.setStyle(this.root, { width: "100%", height: "100%", position: "relative" }),
            (this.urlParams = this.checkData(n.urlParams, n.type)),
          ...
          v()(e, [
            {
              ...
              value: function (e, n) {
                var t = e.streamId,
                  ...
                  c = this.isMobile;
                t || (t = 1),
                  r || (r = "http:" === location.protocol ? "1" : "2"),
                  o ||
                    (c
                      ? (o = "hls")
                      : l
                ...
                return (
                  ...
                  (function (e) {
                    ...
                    return e;
                  })({ streamId: t, protocolType: r, streamType: o, beginTime: i || v, endTime: s || f }, a)
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                var n = this;
                (this.btnPlay = e.querySelector("#playerControls")),
                  (this.btnStop = e.querySelector("#playerStop")),
                  (this.btnSound = e.querySelector("#playerSound")),
                  (this.btnFullScreen = e.querySelector("#playerFullScreen")),
                  (this.playerControls = e.querySelector(".player__controls")),
            ...
            },
            {
              ...
              value: function () {
                (this.isPlaying = !0),
                  this.controls &&
                    p.setAttr(this.btnPlay, "class", "player__btn player__btn-large iconfont iconbofangzanting"),
                  this.poster && (this.poster.style.display = "none"),
                  this.canvasPlayer
                    ? (console.info("canvas play"), this.canvasPlayer.play())
                    : this.videoJsPlayer
                    ? (console.info("videojs play"), this.videoJsPlayer.play())
                    : this.videoPlayer
                    ? (console.info("videoh5 play"), this.videoPlayer.play())
                    : (console.info("other play"), this.createPlayerInstance());
              },
            },
            {
              key: "pause",
              value: function () {
                (this.isPlaying = !1),
                  p.setAttr(this.btnPlay, "class", "player__btn player__btn-large iconfont iconbofang"),
                  this.canvasPlayer && this.canvasPlayer.pause(),
                  this.videoJsPlayer && this.videoJsPlayer.pause(),
            ...
            },
            {
              key: "stop",
              value: function () {
                (this.playerStatus.isMuted = !1),
                  this.videoJsPlayer && this.videoJsPlayer.dispose(),
                  this.videoPlayer && this.root.removeChild(this.videoPlayer),
                  this.canvasPlayer &&
                    (this.canvasPlayer.close(),
                    this.canvasEl && this.root.removeChild(this.canvasEl),
                    this.videoEl && this.root.removeChild(this.videoEl)),
                  (this.isPlaying = !1),
            ...
            },
            {
              ...
              value: function (e) {
                "number" == typeof e
                  ? e > 1 || e < 0
                    ? E("Param of volume must be between from 0 to 1")
                    : (this.videoJsPlayer && (this.videoJsPlayer.muted(!e), this.videoJsPlayer.volume(e)),
                      this.videoPlayer && ((this.videoPlayer.muted = !e), (this.videoPlayer.volume = e)),
                      this.canvasPlayer && this.canvasPlayer.setAudioVolume(e))
                  : E("Param of volume must be a number");
              },
            },
            {
              key: "destroy",
              value: function () {
                if (
                  (this.videoJsPlayer && this.videoJsPlayer.dispose(),
                  this.videoPlayer && (this.root.removeChild(this.videoPlayer), (this.videoPlayer = null)),
                  this.canvasPlayer)
                )
                  try {
                    this.canvasPlayer.close();
            ...
            },
            {
              ...
              value: function (e) {
                (this.tipDom = this.createTip()),
                  ...
                  e.controls && this.createControls(),
                  e.poster && (this.poster = this.createPoster(e.poster)),
                      ...
                      switch ((j.prev = j.next)) {
                        case 0:
                          if (
                            ...
                            (j.prev = 2),
                            (s = location),
                            -1 !== s.protocol.indexOf("http"))
                          ) {
                            j.next = 8;
                            break;
                          }
                          return (
                            E("Please open on HTTP or HTTPS"),
                            (n.message = "Please open on HTTP or HTTPS"),
                            j.abrupt("return", n)
                          );
                        case 8:
                          return (
                            (a = p.transformParamsToString(this.urlParams)),
                            (l = new Date().getTime()),
                            (j.next = 12),
                            A.a.awrap(
                              m()({
                        ...
                        case 12:
                          (c = j.sent),
                            ...
                            console.log("获取播放地址耗时: ".concat(u / 1e3, "s")),
                            (v = c.data),
                            200 === c.status
                              ? ((f = v.result.data),
                                (d = v.result.code),
                                (h = v.result.msg),
                                "0" === d
                                  ? ((n.playUrl = f.url), (n.isSuccess = !0))
                                  : (n.message = h || "获取播放地址失败"))
                              : (n.message = "获取播放地址失败"),
                            (j.next = 24);
                          break;
                        case 20:
            ...
            },
            {
              ...
              value: function (e) {
                var n = this;
                console.log(e.duration - e.currentTime),
                  setTimeout(function () {
                    n.getBufferTime(e);
                  }, 1e3);
              },
                      ...
                      switch ((h.prev = h.next)) {
                        ...
                        case 6:
                          return (
                            ...
                            (this.isRecord = p.isRecord(this.playUrl)),
                            (h.next = 10),
                            A.a.awrap(this.loadScripts())
                          );
                        case 10:
                          if (!this.isRecord) {
                            h.next = 46;
                          ...
                          if (
                            ...
                            p.setAttr(t, "src", this.playUrl),
                            p.setAttr(n, "playsinline", !0),
                            p.setAttr(n, "webkit-playsinline", !0),
                            p.setAttr(n, "x5-playsinline", !0),
                            p.setStyle(n, { width: "100%", height: "100%", objectFit: "fill" }),
                            (r = "my-video-".concat(Math.random().toString(36).substring(2))),
                            p.setAttr(n, "id", r),
                            !this.isMobile)
                          ) {
                            h.next = 30;
                        ...
                        case 30:
                          return (
                            p.setAttr(t, "type", "application/x-mpegURL"),
                            n.appendChild(t),
                            this.root.appendChild(n),
                            (o = { controls: !1, autoplay: !0, muted: !1 }),
                            (i = this),
                            (this.videoJsPlayer = videojs(r, o, function () {
                              i.videoJsPlayer.errorDisplay.off();
                            })),
                            (h.prev = 36),
                            (h.next = 39),
                            A.a.awrap(this.videoJsPlayer.play())
                          );
                        case 39:
                          h.next = 44;
                          break;
                        ...
                        case 49:
                          (this.canvasEl = document.createElement("canvas")),
                            ...
                            (this.frameTime = null),
                            (a = this.playUrl.replace("rtsp://", "").split("/")),
                            (l = s()(a, 1)),
                            (c = l[0]),
                            (u = location),
                            (v = u.protocol),
                            (f = {
                              wsURL: ""
                                .concat("http:" === v && -1 === this.playUrl.indexOf("8556") ? "ws" : "wss", "://")
                                .concat(c),
                            ...
                            (this.canvasPlayer = new PlayerControl(f)),
                            ...
                            this.canvasPlayer.on("UpdateCanvas", function (e) {
                              (d.tipDom.innerHTML = ""),
                                ...
                                (d.frameTime = setTimeout(function () {
                            ...
                            this.canvasPlayer.setAudioVolume(1),
      ...
      S = (function () {
        function e(n) {
          ...
          (this.root = p.$(n)),
            p.setStyle(this.root, { position: "relative", overflow: "hidden", userSelect: "none" }),
            (this.container = document.createElement("div")),
            p.setStyle(this.container, {
              position: "relative",
              display: "flex",
              flexFlow: "row wrap",
              background: "#000",
          ...
          v()(e, [
                ...
                return A.a.async(
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          (!e.src || !e.src instanceof Array) && Y("请填写正确的src"),
                            (this.options = e),
                            (this.options.url = this.options.src),
                            void 0 === this.options.controls && (this.options.controls = !0),
                            void 0 === this.options.autoplay && (this.options.autoplay = !0),
                            (n = !1 === this.options.controls ? "100%" : "calc(100% - 40px)"),
                            p.setStyle(this.container, { height: n }),
                            this._setPlayerSize(),
                            this.renderPlayer(this.options, 1),
                            this.options.controls && this._addControls();
                        case 10:
                        case "end":
                          return t.stop();
                      }
            ...
            },
            {
              ...
              value: function (e) {
                "number" == typeof e
                  ? e > 1 || e < 0
                    ? Y("Param of volume must be between from 0 to 1")
                    : this.playerSet.forEach(function (n) {
                        n.setVolume(e);
                      })
            ...
            },
            {
              ...
              value: function () {
                ...
                if (!this.isFullScreen) {
                  ...
                  this.btnFullScreen &&
                    p.setAttr(this.btnFullScreen, "class", "player__btn player__btn-large iconfont icontuichuquanping");
                }
                (this.isFullScreen = !0), p.setStyle(this.root, { width: "100%", height: "100%" });
              },
            },
            {
              key: "exitFullScreen",
              value: function () {
                this.isFullScreen &&
                  ...
                  this.btnFullScreen &&
                    p.setAttr(this.btnFullScreen, "class", "player__btn player__btn-large iconfont iconquanping"));
            ...
            },
            {
              ...
              value: function () {
                ...
                var n = this.options,
                  ...
                  s = void 0 === i ? "400" : i,
                  a = ["string", "number"];
                a.includes(o()(r)) && a.includes(o()(s))
                  ? ("number" == typeof r
                      ? (e.width = "".concat(r, "px"))
                      : -1 === r.indexOf("px") && -1 === r.indexOf("%")
                      ? (e.width = "".concat(r, "px"))
                      : (e.width = r),
                    "number" == typeof s
                      ? (e.height = "".concat(s, "px"))
                      : -1 === s.indexOf("px") && -1 === s.indexOf("%")
                      ? (e.height = "".concat(s, "px"))
                      : (e.height = s),
                    p.setStyle(this.root, e))
                  : Y('Type of "width" or "height" must be String or Number');
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                var n = this;
                (this.btnFullScreen = e.querySelector("#playerFullScreen")),
                  (this.playerSplit1 = e.querySelector("#playerSplit1")),
                  (this.playerSplit2 = e.querySelector("#playerSplit2")),
                  (this.playerSplit4 = e.querySelector("#playerSplit4")),
                  (this.playerSplit9 = e.querySelector("#playerSplit9")),
              ...
              value: function (e) {
                ...
                if (/^[0-9A-Za-z]+$/i.test(l) && /^\d{1,3}$/.test(c) && ["1", "2"].includes(u))
                  return (
                    ...
                    this._isWarnUser(n) &&
                      console.warn("当前浏览器版本过低，建议使用最新版谷歌浏览器播放视频或切换为标清视频"),
                    { deviceId: l, channelId: c, type: u, urlParams: n }
                  );
            ...
            },
            {
              ...
              value: function (e) {
                var n = !1,
                  t = y.a.name;
                return (
                  ("Firefox" === t || "IE" === t || "Microsoft Edge" === t) &&
                    e.streamType &&
                    "rtsp" === e.streamType &&
                    (n = !0),
                  n
            ...
            },
            {
              ...
              value: function (e, n) {
                ...
                2 === n && ((a.width = "50%"), (a.height = "50%")),
                  4 === n && ((a.width = "50%"), (a.height = "50%")),
                  9 === n && ((a.width = "33.33%"), (a.height = "33.33%")),
                  p.setAttr(this.container, "class", "player__split--".concat(n));
                for (var A = [], l = 0, c = this.container.children.length; l < c; l++)
                  l > n - 1
                    ? (this.container.removeChild(this.container.children[n]),
                      this.playerSet[l] && this.playerSet[l].destroy())
                    : "true" === this.container.children[l].dataset.player && A.push(this.container.children[l]);
                for (var u = 0; u < A.length; u++)
                  (A[u].style.width = a.width),
                    (A[u].style.height = a.height),
                    2 === n
                      ? p.setStyle(A[u], { transform: "translateY(50%)" })
                      : p.setStyle(A[u], { transform: "translateY(0)" });
                var v = A.length;
                setTimeout(function () {
                  for (var e = v || 0; e < n; e++) {
                    var A = document.createElement("div");
                    p.setAttr(A, "data-player", !0),
                      p.setStyle(A, {
                        width: a.width,
                        height: a.height,
                      ...
                      2 === n
                        ? p.setStyle(A, { transform: "translateY(50%)" })
                        : p.setStyle(A, { transform: "translateY(0)" }),
                      t.container.appendChild(A);
                    var l = s instanceof Array ? s[e] : s,
                      c = { isMobile: p.isMobile(), autoplay: o, controls: i, root: A, poster: l };
                    if (r[e]) {
