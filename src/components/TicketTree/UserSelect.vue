<!--
 * @Author: chenzh
 * @Date: 2021-01-29 13:08:58
 * @LastEditTime: 2022-10-25 11:45:20
 * @LastEditors: Do not edit
 * @Description:
 * @FilePath: /wisdomwatervue/src/components/TicketTree/UserSelect.vue
-->
<template>
  <a-select
    :value="userIdList"
...
import { getAllUserApi } from '@/api/work';
