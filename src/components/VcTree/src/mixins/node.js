...
export default {
  methods: {
    ...mapMutations('pub', ['setAutoCompleteStatus', 'setAbloutStatus']),
    ...
    handleClick() {
      // 顶部弹窗隐藏--树点击事件被阻止向上冒泡所以要手动去隐藏
      this.setAbloutStatus(false);
      this.setAutoCompleteStatus(false);
      const node = this.node || this.source;
    ...
    handleChildNodeExpand(nodeData, node, instance) {
      this.broadcast('VcTreeNode', 'tree-node-expand', node);
