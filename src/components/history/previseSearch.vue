...
<script>
import { intervalsP, intervals1, spaces0, spaces1, typeList } from './data';
export default {
  name: 'previseSearch',
  props: {
    itemConfig: {
  ...
  methods: {
    ...
    changeType(type) {
      ...
      this.intervals = type === '0' ? intervalsP : intervals1;
    ...
    changeSearch(query = true) {
      const params = { dates: [], period: '', timeEnum: '', space: this.form.space };
