...
export const customColorList = ['#5f9ea0', '#2BDEAB', '#28D6FE', '#FFA66D', '#E8684A'];
//柱状图
...
export const resultOption = {
  ...
  series: [{ name: '', data: [], type: 'line', smooth: true }]
};
...
export function genCompareOptions(config = {}) {
  let option = {
    grid: [
      {
        left: '16px',
...
export const microbeOption = {
  ...
  xAxis: [
    {
      data: ['厌氧池', '一级缺氧池', '一级好氧池', '二级缺氧池', '二级缺氧池']
    }
  ],
  yAxis: [
    {
