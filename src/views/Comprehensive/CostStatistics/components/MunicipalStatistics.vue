...
<template>
  <div class="content">
    <div class="content-header">
      ...
      <w-button type="primary" @click="toPredict">市政用水</w-button>
    </div>
  ...
  methods: {
    ...
    async getPointList(val) {
      ...
      let dataTime = [],
        flowPvList = [];
      val.forEach(item => {
        dataTime.push(item.recordDate);
        flowPvList.push(item.waterUse);
      });
