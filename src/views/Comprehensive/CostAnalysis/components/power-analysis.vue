...
<template>
  <div class="water-analysis-view">
    <div class="card-box wbgc-card">
      <PowerAll :title="'累计耗电量'" :waterPlantId="waterPlantId" />
    </div>
    <!-- <div class="card-box wbgc-card">
      <PowerProportion :title="'配电间能耗占比'" :waterPlantId="waterPlantId" />
    </div> -->
    <div class="card-box wbgc-card">
      <FactoryAnalysis :title="'能耗分析'" :waterPlantId="waterPlantId" />
    </div>
  </div>
</template>

<script>
import PowerAll from './power-all';
import PowerProportion from './power-proportion';
import FactoryAnalysis from './factory-analysis';
export default {
  name: 'PowerAnalysis',
  components: {
    PowerAll,
