 ...
 * @LastEditTime: 2024-07-26 10:24:32
    ...
    <table-search>
      <w-form-model slot="form" layout="inline" ref="form" :model="form">
        <w-row :gutter="8" type="flex">
          ...
          <w-col v-bind="grid">
            <w-form-model-item label="报警状态" prop="status" :wrapperCol="{ flex: 1 }">
              <w-select v-model="form.status">
                <w-select-option value="">全部</w-select-option>
                <w-select-option value="1">报警中</w-select-option>
                <w-select-option value="0">已结束</w-select-option>
              </w-select>
            </w-form-model-item>
          </w-col>
        ...
        <div class="table-wrapper">
          ...
          >
            ...
            <div slot="action" slot-scope="text, record" class="actions">
              ...
              <a
                v-else
                class="item1 supply-float-left"
                @click="confirmClose(record.alarmHandlerDataId)"
              >
                确认
              </a>
