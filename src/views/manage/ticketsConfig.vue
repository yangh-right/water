      ...
      <w-row slot="form" :gutter="12">
        ...
        <w-col :span="8">
          <w-form-item label="时间范围">
            <w-range-picker v-model="rangeTime" show-time format="YYYY-MM-DD HH:mm:ss" />
          </w-form-item>
        </w-col>
        <w-col :span="6">
        ...
        <w-col class="supply-float-right">
          <w-form-item>
            ...
            <w-button @click="handleReset" class="supply-mx-3">重置</w-button>
            <w-dropdown>
...
export default {
  ...
  watch: {
    rangeTime(o, n) {
      this.options.createTimeStart = this.rangeTime[0]
        ? moment(this.rangeTime[0]).format('YYYY-MM-DD HH:mm:ss')
        : '';
      this.options.createTimeEnd = this.rangeTime[1]
        ? moment(this.rangeTime[1]).format('YYYY-MM-DD HH:mm:ss')
        : '';
    }
  },
  mounted() {
