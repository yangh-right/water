...
<template>
  <card-box :title="cardTitle">
    <div class="supply-w-full supply-h-full">
      <w-radio-group class="supply-mt-1.5 circle-radio" v-model="configCode">
...
const CHART_COLORS = [
  {
    ...
    areaColor: new echarts.graphic.LinearGradient(0, 1, 0, 0, [
      ...
      { offset: 1, color: 'rgba(0,146,246,0.5)' }
    ])
  },
  {
    lineColor: '#00d4c7',
...
export default {
  ...
  methods: {
    ...
    resetChart() {
      ...
      this.barOption.yAxis[0].name = 'L/h'; // 默认单位
    },
    // 格式化时间数据
