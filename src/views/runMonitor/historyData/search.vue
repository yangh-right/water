 ...
 * @LastEditTime: 2022-09-19 18:56:31
-->
<template>
  <w-form-model :model="form" class="query-form">
    <w-form-model-item label="时段">
    ...
    <w-form-model-item v-if="form.type === '0'" label="间隔">
    ...
    changeSearch(type) {
      ...
      if (this.form.type === this.typeList[0].value) {
        ...
        if (this.form.interval === '1hours' || this.form.interval === '24hours') {
          ...
          params.period = 1;
          params.timeEnum = 'HOURS';
        } else if (this.form.interval === '30days') {
          params.period = 1;
          params.timeEnum = 'HOURS';
        }
      } else {
