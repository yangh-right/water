<template>
  <div class="base-info wfc1">
    <div class="form-title">分光光度法测定总磷</div>
    <w-info-form ref="tpForm" :model="form" :fields="baseFields" :layout="layout" :footer="null">
    </w-info-form>
    <div class="table-container">
      ...
      >
        ...
        <template slot="measuredAbsorbance" slot-scope="text, record">
          <w-input v-model="record.measuredAbsorbance" type="number" :style="{ width: '100px' }" />
        </template>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          key: 'measuredAbsorbance',
          align: 'center',
          width: 120,
          scopedSlots: {
            customRender: 'measuredAbsorbance'
          }
        },
        {
          title: '质量(ug)',
